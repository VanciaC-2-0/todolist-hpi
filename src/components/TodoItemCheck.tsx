...
const TodoItemCheck = (props: TodoItemInterface) => {
    //Check todo component
    return(
        <div className="todo-item checked-item">
            {props.todo.isCompleted ? 
                <div className="todo-item-input">
                    <div onClick={() => props.handleTodoIsComplete(props.todo.id, props.todo)} className="todo-item-check">
                        {props.todo.isCompleted ? (<span className="todo-item-checked">NOT DONE!</span>) : (<span className="todo-item-unchecked">DONE !</span>)}  
                    </div>
